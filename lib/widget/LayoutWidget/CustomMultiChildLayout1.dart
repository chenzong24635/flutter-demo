...
class CustomMultiChildLayout1Page extends StatefulWidget {
  @override
  _CustomMultiChildLayout1PageState createState() =>
      _CustomMultiChildLayout1PageState();
}

class _CustomMultiChildLayout1PageState extends State<CustomMultiChildLayout1Page> {
  ///用于 LayoutId 指定
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: new Text("CustomMultiChildLayout1Page"),
      ),
      body: new Center(
        child: new Container(
